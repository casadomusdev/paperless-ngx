...
| `PAPERLESS_MAIL_QUEUE_CRON` | Cron | `*/5 * * * *` | How often the pending email queue is checked (set to `disable` to turn off) | [Mail System](mail-system.md#16-email-send-queue-with-retry-v150) |
