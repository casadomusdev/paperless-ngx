...
PAPERLESS_MAIL_TO_FIELD = os.getenv("PAPERLESS_MAIL_TO_FIELD", "")
PAPERLESS_MAIL_CC_FIELD = os.getenv("PAPERLESS_MAIL_CC_FIELD", "")
PAPERLESS_MAIL_BCC_FIELD = os.getenv("PAPERLESS_MAIL_BCC_FIELD", "")
PAPERLESS_MAIL_BODY_FIELD = os.getenv("PAPERLESS_MAIL_BODY_FIELD", "")
# /end RKC edit
